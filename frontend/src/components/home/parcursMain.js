            ...
            <div className="text-center">
                ...
                <ParcursText direction="left" img={LSAC}
                            ...
                            description={<>După ce am participat la mai multe ședințe organizate de LSAC, dar și știind câte
                                ceva despre activitatea lor, am decis că mi-ar plăcea să fac parte din ligă. Zis și făcut. Am
                                aplicat, am susținut toate interviurile și așa am ajuns să fiu acceptat în această comunitate.
                            </>}
                />
                
                <ParcursText direction="right" img={IT}
                            title="Membru în Departamentul de IT - LSAC" period="Decembrie 2022 - Prezent"
                            description={<>După perioada interviurilor cu liga, a urmat o perioadă în care puteam să ne înscriem
                                la câte departamente doream din cadrul ligii. Am ales să mă înscriu și în "Departamentul de IT"
                                unde pot spune cu mâna pe inimă că nu regret nicio clipă petrecută aici.
                            </>}
                />
